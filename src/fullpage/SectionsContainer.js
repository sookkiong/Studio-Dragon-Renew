      ...
      (_ret =
        ((_temp =
          ((_this = _possibleConstructorReturn(
            this,
            (_ref =
              SectionsContainer.__proto__ ||
              Object.getPrototypeOf(SectionsContainer)).call.apply(
              _ref,
              [this].concat(args)
            )
          )),
        ...
        (_this.removeActiveClass = function () {
          var activeLinks = document.querySelectorAll(
            'a:not([href="#' +
              _this.props.anchors[_this.state.activeSection] +
              '"])'
          );
        ...
        (_this.handleMouseWheel = function (event) {
          ...
          if (
            _this.state.scrollingStarted ||
            activeSection < 0 ||
            _this.childrenLength === activeSection
          ) {
            return false;
          }
        ...
        (_this.handleSectionTransition = function (index) {
          ...
          if (
            !_this.props.anchors.length ||
            index === -1 ||
            index >= _this.props.anchors.length
          ) {
            return false;
          }
        ...
        (_this.handleTouchNav = function () {
          ...
          var touchsurface = document.querySelector(
        ...
        (_this.renderNavigation = function () {
          ...
          var anchors = _this.props.anchors.map(function (link, index) {
            var anchorStyle = {
              ...
              transition: "all 0.2s",
              transform:
                _this.state.activeSection === index ? "scale(1.3)" : "none",
            };
            ...
            return _react2.default.createElement("a", {
              ...
              key: index,
              className:
                _this.props.navigationAnchorClass || "Navigation-Anchor",
