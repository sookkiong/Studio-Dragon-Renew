  ...
  return (
    <Container>
      <Inner>
        ...
        <LinknCopyWrap>
          <FLink>
            <Link id={HoverID("1")} onMouseOver={() => onMouse("1")}>
              법적고지
            </Link>
            <Link id={HoverID("2")} onMouseOver={() => onMouse("2")}>
              이메일무단수집거부
            </Link>
            <Link id={HoverID("3")} onMouseOver={() => onMouse("3")}>
              사이버감사실
            </Link>
            <Link id={HoverID("4")} onMouseOver={() => onMouse("4")}>
              CONTACT US
            </Link>
          </FLink>
